...
const quelle = join(here, '..', 'zusammenarbeit', 'bericht.md');
...
function pngGroesse(pfad) {
    const b = readFileSync(join(here, '..', 'zusammenarbeit', pfad));
...
writeFileSync(ziel, `% Automatisch erzeugt aus zusammenarbeit/bericht.md – nicht von Hand bearbeiten.\n\n${out.join('\n')}`);
