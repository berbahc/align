...
Informationen wir dafür erheben müssen und was der Markt bereits abdeckt. Dieses Kapitel
fasst beide Vorarbeiten zusammen: die Anforderungsanalyse und die Competitor-Analyse. Beide
entstanden in Phase 1 (Kapitel 4).

## 2.1 Stakeholder und Informationsbedarf

Primäre Stakeholder sind **Studierende zwischen 18 und 35 Jahren**, die Schwierigkeiten
haben, Routinen aufzubauen, oder sich von ihrem Alltag überfordert fühlen. Als sekundäre
Gruppe haben wir Fachleute aus Psychologie und Verhaltensforschung identifiziert — etwa die
psychologische Beratungsstelle der Hochschule —, deren Perspektive für die Gestaltung
relevant ist, auch wenn sie die Anwendung nicht selbst nutzen.
...
Diese Fragen haben wir in Phase 2 über zwei Erhebungsmethoden beantwortet — qualitative
Leitfadeninterviews und eine quantitative Online-Umfrage (Kapitel 5). Der letzte Punkt hat
dabei eine eigene Geschichte: Aus ihm wurde später eine konkrete Produktregel (Abschnitt 6.3).

## 2.2 Competitor-Analyse

### Ziel und Methodik

Die Competitor-Analyse beantwortet drei Fragen: Wer ist im Markt aktiv? Wo ist die
Marktlücke? Und was lässt sich für das eigene MVP lernen — welche Mechaniken funktionieren,
welche sollten vermieden werden?

Zum Stichtag 19. Mai 2026 haben wir **acht Anwendungen** entlang von vier Dimensionen
untersucht: Zielgruppe und Positionierung, Features, Gamification und UX sowie
...
qualitativ mit Belegen, nicht als reinen Feature-Vergleich.

Die Auswahl umfasst bewusst nicht nur direkte Wettbewerber, sondern auch Anwendungen aus
angrenzenden Kategorien, die Studierende ohnehin im Alltag nutzen:
...
*Implikation:* Gamifizierung funktioniert, ist hier aber überdosiert — Align setzt auf
subtile Mechaniken, die unterstützen statt zu dominieren.
...
Fundierung ist ein echter Mehrwert; Personalisierung sollte aber tatsächlich adaptiv sein.
...
der wissenschaftliche Anspruch und die Tracking-Tiefe bleiben gering. *Implikation:*
Tonalität zählt mehr als Feature-Breite — mit ernsterer Methodik dahinter.

**Streaks** ist der minimalistische Gegenpol: schönes Design, keine Abo-Pflicht, aber auch
keine Personalisierung und keine Begleitung. *Implikation:* Minimalismus ist ein Trumpf, ein
reiner Tracker ist aber zu wenig.
...
Gewohnheitslogik. *Implikation:* Hier ist kein Wettbewerb nötig; die Bindung an etwas
Größeres wirkt jedoch nachweislich motivierend.

**Headspace** ist der Wellness-Anbieter mit der bislang ernsthaftesten KI-Integration: ein
konversationeller Begleiter mit adaptiven Empfehlungen. Eine echte Gewohnheitslogik fehlt.
*Implikation:* die direkte Referenz für unsere eigene KI-Assistenz — mit der Lehre, dass KI
empathisch wirken muss, nicht klinisch.

**Notion** ist kein Wettbewerber im engeren Sinn, aber das Werkzeug, mit dem viele
Studierende ihre Routinen heute tatsächlich abbilden. Der Preis dafür ist ein hoher
Einrichtungsaufwand ohne jede Begleitung. *Implikation:* Die meisten dieser selbstgebauten
Tracker scheitern an der Konsistenz — genau dort setzt Align an.
...
Im Vergleich: Habitica ist zu spielerisch, Fabulous zu generisch, Notion verlangt zu viel
Einrichtung, Athenify ist zu schmal. Align liefert das Passende in einer einfachen
...
Schuldwert in der Umfrage — und ist heute an mehreren Stellen der Anwendung sichtbar: neutral
dargestellte Fehltage, keine Serie, die bei einem verpassten Tag zusammenbricht, und eine
Konsistenzrate, die nur Tage zählt, an denen die Gewohnheit tatsächlich anstand.
