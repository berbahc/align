...
nur drei Tage; entsprechend bescheiden war unser Anspruch: eine tragfähige Idee vorstellen
und zeigen, dass wir eine Richtung haben.
...
bewusst ausgeschlossen: Wir haben uns früh darauf festgelegt, Produktentscheidungen nur auf
peer-reviewte Literatur zu stützen.

Drei Quellen bildeten von hier an unsere wissenschaftliche Grundlage:

| Quelle | Kernbefund | Wirkung im Produkt |
|---|---|---|
| **Lally et al. (2010)** | Median 66 Tage bis zur stabilen Gewohnheit (Spanne 18–254). Konsistenz ist der wichtigste Prädiktor, nicht die absolute Anzahl der Ausführungen; einzelne Aussetzer haben keine messbaren Langzeitkosten. | Konsistenzrate statt Streak · kein Bestrafungsmechanismus · realistische Erwartungen |
...
Diese Zuordnung ist kein nachträglicher Beleg, sondern hat unsere Feature-Auswahl tatsächlich
...
Wir haben acht Anwendungen entlang von vier Dimensionen untersucht — Zielgruppe und
...
3. **Aggressive oder verlustaversive Gamification erzeugt Druck statt Motivation** —
   besonders bei jüngeren Zielgruppen. Habitica überfordert, reine Streak-Logiken machen
   anfällig für Aufgabe nach dem ersten Fehltag.
...
Bezug zu konkreten Features, sondern damit wir eine gemeinsame Vorstellung davon haben,
worüber wir sprechen. Aus ihnen stammt bereits die Farbrichtung, die uns bis zum Ende
begleitet hat: Beige, Schwarz und Gold, mit der Idee eines Dark- und Light-Modes.
...
- **Reihenfolge der Nutzerforschung:** erst Interviews führen, die Online-Umfrage daraus
  ableiten — nicht beides parallel entwickeln.
- **Datenschutz und Anonymität** bei der Umfrage beachten; Hinweis auf das Umfragewerkzeug
  der Hochschule.
...
- **Sozialer Aspekt** als Anregung: „ich bin nicht allein", gegenseitige Motivation,
  Community.
...
gesamten Projekts. Er begründete das zweistufige Vorgehen der folgenden Phase — qualitative
Interviews zur Hypothesenbildung, quantitative Umfrage zur Validierung — und damit die
empirische Grundlage, auf der später jede unserer Feature-Entscheidungen ruht.
