...
beides Korrekturen, die früh und dadurch billig kamen.
...
überbrückt, war für uns das überraschendste Ergebnis der letzten Phase.
...
knappe Notiz, die Schwierigkeit habe darin bestanden, zwei Ziele zu vereinbaren: die
...
Unsere Konzeptphase ging von einer nativen mobilen Anwendung mit React Native und Expo aus,
mit Supabase als Backend-Dienst. Gebaut haben wir eine mobil-first Web-App mit Laravel. Die
Gründe stehen in Abschnitt 7.1: eine Codebase statt zweier Builds, kein Freigabeprozess
zwischen Änderung und Nutzer, und ein Framework, das Routing, Validierung, Authentifizierung
und ein Testgerüst mitbringt.
...
Dazu kommt eine Grenze, die im Bericht bisher nur durch ihre Abwesenheit sichtbar wird: **Die
fertige Anwendung ist nie mit Nutzern getestet worden.** Nach Abschluss der Nutzerforschung
